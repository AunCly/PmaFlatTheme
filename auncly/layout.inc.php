...
// $GLOBALS['cfg']['bleu_info']               = '#3498db';
// $GLOBALS['cfg']['bleu_foncé']
// $GLOBALS['cfg']['bleu_foncé']
// $GLOBALS['cfg']['gris']
// $GLOBALS['cfg']['rouge']
 ...
 */
 ...
 /* Masked Elements */
 $GLOBALS['cfg']['mask_bookmark_form'] = true;
 $GLOBALS['cfg']['mask_request_tools'] = true;
 $GLOBALS['cfg']['mask_table_statistics'] = true;
?>
